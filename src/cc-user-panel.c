...
static GtkWidget *
get_widget (CcUserPanel *d, const char *name)
{
...
static void
show_error_dialog (CcUserPanel *d,
                   const gchar *message,
                   GError      *error)
{
	GtkWidget *dialog;
...
static ActUser *
get_selected_user (CcUserPanel *d)
{
	GtkTreeView *tv;
	GtkTreeIter iter;
...
static void show_user (ActUser *user, CcUserPanel *d);

static void
user_added (ActUserManager *um, ActUser *user, CcUserPanel *d)
{
	GtkWidget *widget;
	GtkTreeModel *model;
	GtkListStore *store;
...
static void
user_removed (ActUserManager *um, ActUser *user, CcUserPanel *d)
{
	GtkTreeView *tv;
	GtkTreeModel *model;
	GtkTreeSelection *selection;
...
static void
user_changed (ActUserManager *um, ActUser *user, CcUserPanel *d)
{
	GtkTreeView *tv;
	GtkTreeSelection *selection;
	GtkTreeModel *model;
                                 ...
                                 gpointer            user_data)
{
	...
	CcUserPanel *d = CC_USER_PANEL (user_data);
...
static void
delete_user (GtkButton *button, CcUserPanel *d)
{
	ActUser *user;
	GtkWidget *dialog;
	...
	if (user == NULL) {
		...
		g_signal_connect (dialog, "response",
			G_CALLBACK (delete_enterprise_user_response), d);
	}
...
static void
show_user (ActUser *user, CcUserPanel *d)
{
	GtkWidget *image;
	GtkWidget *label;
	GtkWidget *widget;
...
static void
selected_user_changed (GtkTreeSelection *selection, CcUserPanel *d)
{
	GtkTreeModel *model;
	GtkTreeIter iter;
	ActUser *user;
...
static void
change_password (GtkButton *button, CcUserPanel *d)
{
	ActUser *user;
...
static void
change_fingerprint (GtkButton *button, CcUserPanel *d)
{
	GtkWidget *widget;
	ActUser *user;
...
static void
show_history (GtkButton *button, CcUserPanel *d)
{
	ActUser *user;
                       ...
                       gpointer     data)
{
	...
	CcUserPanel *d = CC_USER_PANEL (data);
...
static void
setup_main_window (CcUserPanel *d)
{
	GtkWidget *userlist;
	GtkTreeModel *model;
	GtkListStore *store;
	...
	gtk_tree_view_set_search_equal_func (GTK_TREE_VIEW (userlist), match_user, NULL, NULL);
...
cc_user_panel_dispose (GObject *object)
{
	...
	if (self->other_iter) {
		gtk_tree_iter_free (self->other_iter);
		self->other_iter = NULL;
	}
